(()=>{"use strict";var d=window.DataGridLabels??{page:"Page",gotoPage:"Go to page",gotoFirstPage:"Go to first page",gotoPrevPage:"Go to previous page",gotoNextPage:"Go to next page",gotoLastPage:"Go to last page",of:"of",items:"items"},b=document.createElement("template");b.innerHTML=`
<table role="grid" >
    <thead role="rowgroup">
        ...
        <tr role="row" aria-rowindex="1">
            ...
            <div class="dg-footer">
                <div class="dg-page-nav">
                  ${d.page} <input type="number" class="dg-goto-page" min="1" step="1" value="1" aria-label="${d.gotoPage}">
                </div>
