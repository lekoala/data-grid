...
<style id="dg-styles">
  ...
  @media only screen and (max-width: 767px) {
    data-grid[responsive] ${s} { top: 8rem; left: 42%; } 
  }
</style>
`;if(!document.getElementById("dg-styles")){let r=document.querySelector("head")??document.querySelector("body"),l=/head/i.test(r.tagName)?"beforeend":"afterbegin";r.insertAdjacentHTML(l,o)}t.insertAdjacentHTML("afterbegin",`<i class="${i}"></i>`)}},Dt=ct;K.registerPlugins({ColumnResizer:bt,ContextMenu:vt,DraggableHeaders:xt,TouchSupport:yt,SelectableRows:Pt,FixedHeight:wt,AutosizeColumn:Et,ResponsiveGrid:Lt,RowActions:kt,EditableColumn:Rt,SpinnerSupport:Dt});customElements.get("data-grid")||customElements.define("data-grid",K);var ai=K;export{ai as default};
