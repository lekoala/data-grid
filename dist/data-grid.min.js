...
`;if(!H("#dg-styles")){let o=H("head")??H("body"),r=/head/i.test(o.tagName)?"beforeend":"afterbegin";o.insertAdjacentHTML(r,s)}!H(`i${i}`,t)&&t.insertAdjacentHTML("afterbegin",`<i class="${e}"></i>`)}},$t=ut;_.registerPlugins({ColumnResizer:vt,ContextMenu:xt,DraggableHeaders:yt,TouchSupport:Ct,SelectableRows:wt,FixedHeight:Et,AutosizeColumn:St,ResponsiveGrid:kt,RowActions:Rt,EditableColumn:Dt,SpinnerSupport:$t});customElements.get("data-grid")||customElements.define("data-grid",_);var li=_;export{li as default};
