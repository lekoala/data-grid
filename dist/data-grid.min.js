...
`;if(!W("#dg-styles")){let o=W("head")??W("body"),r=/head/i.test(o.tagName)?"beforeend":"afterbegin";o.insertAdjacentHTML(r,s)}!W(`i${i}`,t)&&t.insertAdjacentHTML("afterbegin",`<i class="${e}"></i>`)}},$t=ut;_.registerPlugins({ColumnResizer:vt,ContextMenu:yt,DraggableHeaders:xt,TouchSupport:Ct,SelectableRows:wt,FixedHeight:Et,AutosizeColumn:Lt,ResponsiveGrid:kt,RowActions:Rt,EditableColumn:Dt,SpinnerSupport:$t});customElements.get("data-grid")||customElements.define("data-grid",_);var di=_;export{di as default};
/**
