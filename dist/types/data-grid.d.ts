...
export type Column = {
    ...
    minWidth?: number;
    /**
     * - horizontal alignment of the column's header, body, and filter control, defaults to the formatter default when `format` is set (e.g. `number` -> `end`, `boolean` -> `center`)
     */
